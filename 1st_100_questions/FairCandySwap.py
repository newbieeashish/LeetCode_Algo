...
Since they are friends, they would like to exchange one candy bar each so
 ...
 (The total amount of candy a person has is the sum of the sizes of candy bars 
they have.)
...
def FairCandySwap(A,B):
    ...
    for num in B:
        if num+diff in UniqueA:
            return [num+diff, num]

print(FairCandySwap([1,2,5],[1,2,5]))
